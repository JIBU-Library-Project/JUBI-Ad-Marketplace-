...
const SlidingHeadline = () => {
  const slogans = [
    ...
    { white: "Your Ad,", yellow: "Their Next Purchase." },
    { white: "Smarter Ads,", yellow: "Greater Reach." },
    { white: "Reach More,", yellow: "Spend Less." },
    { white: "List It,", yellow: "Let It Work for You." },
  ];
    ...
    const interval = setInterval(() => {
      ...
      setTimeout(() => {
        setCurrentIndex((prev) =>
          prev === slogans.length - 1 ? 0 : prev + 1
        );
  ...
  return (
    <div className="pt-5 pb-5">
      ...
      >
        ...
        <span className="text-yellow-400">{slogans[currentIndex].yellow}</span>
      </span>
    </p>
    </div>
  );
